...
const LanguageInfoModal: React.FC<LanguageInfoModalProps> = ({
  ...
  const inlineIconSize = isMobile
    ? inlineIconSizeMobile
    : inlineIconSizeDesktop;
  ...
  return (
    <div className="language-info-modal-overlay">
      ...
      <style jsx>{`
        ...
        .language-info-modal-card {
          position: relative;
          border-radius: 15px;
          padding: 28px 18px 20px 18px;
          background: var(--background, #111014);
          box-shadow:
            0 3px 12px rgba(0, 0, 0, 0.11),
            0 0 0 1px var(--background-adjacent-color, #33313d);
          outline: 1px solid var(--background-adjacent-color, #33313d);
          margin: 0 auto;
          overflow: hidden;
          width: 100%;
        }
        .language-info-modal-foreground {
          border-radius: 15px;
          position: relative;
          z-index: 3;
        }
        .language-info-modal-card .inscriptions {
          margin-bottom: 2em;
        }
        .ok-btn-row {
          display: flex;
        ...
        .language-icon-top :global(svg) {
          width: 100%;
          height: 100%;
          display: block;
        }
        .language-icon-inline {
          display: inline-flex;
          align-items: center;
          height: 1.2em;
          aspect-ratio: 1 / 1;
        ...
        .language-icon-inline :global(svg) {
          width: 100%;
          height: 100%;
          display: block;
        }
        .language-info-modal-card .shine {
        ...
        .language-info-modal-card:hover .shine {
          opacity: 1;
          transition-delay: 0s;
        }
        .language-info-modal-card .shine:before {
          content: "";
          width: 150%;
          padding-bottom: 150%;
          border-radius: 50%;
          ...
          background-image: conic-gradient(
            ...
            rgba(161, 35, 244, 0) 0deg,
            #a123f4 25deg,
            rgba(161, 35, 244, 0.18) 295deg,
            rgba(161, 35, 244, 0) 360deg
          );
        }
        .language-info-modal-card .background {
          border-radius: inherit;
          position: absolute;
          inset: 0;
          overflow: hidden;
        ...
        .language-info-modal-card .tiles {
          opacity: 0;
          transition: opacity 0.25s;
        }
        .language-info-modal-card:hover .tiles {
          opacity: 1;
          transition-delay: 0.25s;
        }
        .language-info-modal-card .tile {
          position: absolute;
          background: rgba(161, 35, 244, 0.05);
          animation-duration: 8s;
          animation-iteration-count: infinite;
          opacity: 0;
        }
        .language-info-modal-card .tile.tile-1 {
          top: 0;
          left: 0;
          height: 10%;
          width: 22.5%;
        }
        .language-info-modal-card .tile.tile-2 {
          top: 0;
          left: 22.5%;
          height: 10%;
          width: 27.5%;
        }
        .language-info-modal-card .tile.tile-3 {
          top: 0;
          left: 50%;
          height: 10%;
          width: 27.5%;
        }
        .language-info-modal-card .tile.tile-4 {
          top: 0;
          left: 77.5%;
          height: 10%;
          width: 22.5%;
        }
        .language-info-modal-card .tile.tile-5 {
          top: 10%;
          left: 0;
          height: 22.5%;
          width: 22.5%;
        }
        .language-info-modal-card .tile.tile-6 {
          top: 10%;
          left: 22.5%;
          height: 22.5%;
          width: 27.5%;
        }
        .language-info-modal-card .tile.tile-7 {
          top: 10%;
          left: 50%;
          height: 22.5%;
          width: 27.5%;
        }
        .language-info-modal-card .tile.tile-8 {
          top: 10%;
          left: 77.5%;
          height: 22.5%;
          width: 22.5%;
        }
        .language-info-modal-card .tile.tile-9 {
          top: 32.5%;
          left: 50%;
          height: 22.5%;
          width: 27.5%;
        }
        .language-info-modal-card .tile.tile-10 {
          top: 32.5%;
          left: 77.5%;
          height: 22.5%;
          width: 22.5%;
        }
        .language-info-modal-card:hover .tile {
          animation-name: tile;
        }
        .language-info-modal-card .tile.tile-4,
        .language-info-modal-card .tile.tile-6,
        ...
        .language-info-modal-card:hover .line {
          opacity: 1;
          transition-duration: 0.15s;
        }
        .language-info-modal-card .line:before,
        .language-info-modal-card .line:after {
          content: "";
          position: absolute;
          background: #2a2b2c;
        ...
        .language-info-modal-card .line.line-1:before {
          top: 10%;
        }
        .language-info-modal-card .line.line-1:after {
          left: 22.5%;
        }
        .language-info-modal-card .line.line-2:before {
          top: 32.5%;
        }
        .language-info-modal-card .line.line-2:after {
          left: 50%;
        }
        .language-info-modal-card .line.line-3:before {
          top: 55%;
        }
        .language-info-modal-card .line.line-3:after {
          right: 22.5%;
        }
        .language-info-modal-card:hover .line:before {
          transform: scaleX(1);
        }
        .language-info-modal-card:hover .line:after {
          transform: scaleY(1);
        }
      `}</style>
    </div>
