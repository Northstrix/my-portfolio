    ...
    >
      ...
      >
        <div className="flex flex-col items-center w-full" style={{ maxWidth: '600px' }}>
          <div className="relative w-full mx-auto" style={{ aspectRatio: isMobile ? '412/640' : '16/9' }}>
            <AnimatePresence>
              <motion.div
                key="card-1"
              ...
              >
                <div className="absolute inset-0 w-full h-full">
                  <div className="absolute inset-0 overflow-hidden">
                    <div ref={cardRef} style={{ maxWidth: '100%', width: '100%' }} data-component-id="card-2" onClick={() => onCardClick(1)}>
                      <div
                        style={{
                          borderRadius: outerRounding,
                          padding: '1px',
                          background: isHovered ? 'var(--background-adjacent-color)' : 'var(--refresh-inscription-color)',
                      ...
                      >
                        <div
                          style={{
                            backgroundColor: isHovered ? 'var(--background)' : 'var(--foreground)',
                            padding: '16px',
                            borderRadius: innerRounding,
                            width: '100%',
                            height: '100%',
                        ...
                        >
                          <div
                            ...
                            style={{
                              ...
                              flexDirection: 'row',
                              zIndex: 2,
                              color: isHovered ? 'var(--foreground)' : 'var(--background)',
                              fontWeight: 'bold',
                          ...
                          <div style={{ flex: 1, display: 'flex', flexDirection: isMobile ? 'column' : 'row', alignItems: 'center', position: 'relative', width: '100%' }}>
                            <div style={{ transform: !isMobile ? 'translateX(-23px)' : 'none', position: 'relative', height: isMobile ? 'auto' : '100%', width: isMobile ? '100%' : '50%', aspectRatio: '1/1', padding: '15px' }}>
                              <Image src="/second-playground-card-image.webp" alt="" fill style={{ objectFit: 'contain', objectPosition: 'center' }} priority sizes="412px 16 9" />
                            </div>
                            <div style={{ transform: !isMobile ? 'translateX(-52px)' : 'none', display: isMobile? '' : 'flex', textAlign: isMobile ? 'center' : 'left', flexDirection: 'column', alignItems: 'flex-start', width: isMobile ? '100%' : '50%', padding: '15px' }}>
