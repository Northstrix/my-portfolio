...
export const SplashedPushNotifications = forwardRef<SplashedPushNotificationsHandle, SplashedPushNotificationsProps>(
  ({ maxWidth = "436px", bodyBorderRadius = "var(--border-radius)", typeIconContainerBorderRadius = "50%", closeIconBorderRadius = "var(--border-radius)", timerColor = "rgba(255,255,255,0.8)", timerBgColor = "rgba(255,255,255,0.3)", horizontalMargin = "1.5rem", verticalGap = "1.5rem", lowestContainerBottomMarginAdjustment = "-0.25rem", customIcons = {} }, ref) => {
