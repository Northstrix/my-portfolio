...
const EmbeddedProjectsContent: React.FC<EmbeddedProjectsContentProps> = ({
  isRTL,
  onProjectClick,
}) => {
  ...
  const projects: Project[] = [
    {
      name: t("embedded-project-1-name"),
      description: t("embedded-project-1-description"),
      image: t("embedded-project-1-image"),
      link: t("embedded-project-1-link"),
      designation: t("embedded-project-1-designation"),
    },
    {
      name: t("embedded-project-2-name"),
      description: t("embedded-project-2-description"),
      image: t("embedded-project-2-image"),
      link: t("embedded-project-2-link"),
      designation: t("embedded-project-2-designation"),
    },
    {
      name: t("embedded-project-3-name"),
      description: t("embedded-project-3-description"),
      image: t("embedded-project-3-image"),
      link: t("embedded-project-3-link"),
      designation: t("embedded-project-3-designation"),
    },
    {
      name: t("embedded-project-4-name"),
      description: t("embedded-project-4-description"),
      image: t("embedded-project-4-image"),
      link: t("embedded-project-4-link"),
      designation: t("embedded-project-4-designation"),
    },
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 max-w-full mx-auto">
              {projects.map((project, index) => (
                <ProjectCard
                  ...
                  buttonInscriptions={{
                    openWebAppButton: t("learn-more-button-inscription"),
                  }}
