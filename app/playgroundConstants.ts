export const quotes = [
    ...
    { author: "Anaïs Nin", quote: "We don't see things as they are, we see them as we are.", hebrewQuote: "אנחנו לא רואים את הדברים כפי שהם, אנחנו רואים אותם כפי שאנחנו", hebrewAuthor: "אנאיס נין" },
