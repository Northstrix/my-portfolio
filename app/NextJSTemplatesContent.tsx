...
const WebProjectsContent: React.FC<WebProjectsContentProps> = ({
  ...
  const projects: Project[] = [
    {
      name: t("next-js-template-1-name"),
      description: t("next-js-template-1-description"),
      image: t("next-js-template-1-image"),
      link: t("next-js-template-1-link"),
      designation: t("next-js-template-1-designation"),
    },
    {
      name: t("next-js-template-2-name"),
      description: t("next-js-template-2-description"),
      image: t("next-js-template-2-image"),
      link: t("next-js-template-2-link"),
      designation: t("next-js-template-2-designation"),
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 max-w-full mx-auto">
            {projects.map((project, index) => (
              <ProjectCard
                ...
                buttonInscriptions={{
                  openWebAppButton: t("view-template-button-inscription"),
                }}
